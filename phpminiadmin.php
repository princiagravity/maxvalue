...
$ACCESS_PWD='404'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

#DEFAULT db connection settings
# --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
$DBDEF=array(
'user'=>"gravigw4_maxvalue",#required
'pwd'=>"gravigw4_maxvalue", #required
'db'=>"gravigw4_maxvalue",  #optional, default DB
'host'=>"",#optional
'port'=>"",#optional
