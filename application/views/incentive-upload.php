                   ...
                   <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title"> Incentive Upload</h4>
                           </div>
                        </div>
                        <div class="iq-card-body">
                           
                           <form id="incentive_upload" method="POST" action="incentive_upload" data-form="ajaxform" enctype="multipart/form-data">
                              <div class="form-row">
                              ...
                              <?php if($company_id =="")
                                 ...
                                 <select class="form-control" id="month_id" name="month_id" required>
                                    ...
                                    <input  type="number" min="2000" max="<?php echo date("Y")?>" step="1"  class="form-control" placeholder="Year" name="year"/>
                                 </div>
                              ...
                              <div class="form-row">
                                 ...
                                 <input class="form-check-input" type="radio" name="incentive_type" id="inlineRadio1" value="fresh" required checked>
                                 <label class="form-check-label" for="inlineRadio1" >Fresh  </label>
                                 <input class="form-check-input" type="radio" name="incentive_type" id="inlineRadio1" value="renewal" >  
                                 <label class="form-check-label" for="inlineRadio1" >Renewal</label>
                                 </div>
                                 </div>
                              </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title">Incentive Uploads</h4>
                        </div>
                     ...
                     <div class="iq-card-body">
                        <div class="table-responsive">
                           <table class="table mb-0 table-borderless">
                             ...
                             <?php 
                               ...
                               <tr>
                                 ...
                                 <td><?php echo $details->month_id.' - '.$details->year;?></td>
                         ...
                         <span class="table-remove"><button type="button"
                                       class="btn iq-bg-danger btn-rounded btn-sm my-0"><a href="<?php echo site_url(('single-incentive/'.$details->id))?>">View</a></button></span>
                                   ...
                                   <!--     <span class="table-remove"><button type="button"
                                       ...
                                       <input type="hidden" name="delitem" class="delitem" value="<?php echo $details->filename;?>">   
                                       <input type="hidden" name="deltype" class="deltype" value="incentive">
