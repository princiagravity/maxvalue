                   ...
                   <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Canvasser Search</h4>
                           </div>
                        </div>
                        <div class="iq-card-body">
                          
                           <form id="canvasser_search" method="POST" action="canvasser_search" data-form="ajaxform" enctype="multipart/form-data">
                              <div class="form-row">
                             <!--  <div class="col">
                              ...
                              <div class="form-row">
                                 <div class="col">
                                  <label>Enter Canvasser Name</label>
                                    <input type="text" class="form-control chk_canvassername" placeholder="Canvasser Name" id="canvasser_name" name="customer_name" value="">
                                    <input type="hidden" name="cust_name" id="canvasser_name" value="">
                                 </div>
                                 <div class="col">
                                  <label>Canvas Code</label>
                                    <input type="text" class="form-control" placeholder="Code" name="canvas_code" value="">
                                 </div>
                                <!--  <div class="col">
