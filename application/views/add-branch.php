               ...
               <div class="col-lg-12">
                   <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           ...
                           <form id="add_branch" method="POST" action="<?php echo $action;?>" data-form="ajaxform" enctype="multipart/form-data">
                              <div class="form-row">
                                  <div class="col">
                                  <label><?php echo $lbl_name;?></label>
                                    <input type="text" class="form-control" placeholder="Branch name" name="name" value="<?php echo $name;?>" required>
                                 </div>
                             ...
                             <?php 
                               ...
                               <tr>
                                ...
                                <!--    <span class="table-remove"><button type="button"
                                       ...
                                       <span class="table-remove"><button type="button"
                                       class="btn iq-bg-danger btn-rounded btn-sm my-0"><a href="<?php echo site_url(('update-branch/'.$detail->id))?>">Update</a></button></span>
                                       <span class="table-remove"><input type="hidden" name="delitem" class="delitem" value="<?php echo $detail->name;?>"><input type="hidden" name="deltype" class="deltype" value="branch">
