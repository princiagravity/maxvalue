      ...
      <div id="content-page" class="content-page">
       ...
       {/*  print_r($update); */
         ...
         $company_id=$update['data'][0]->company_id;
         $lbl_name="Name";
               ...
               <div class="col-lg-12">
                   <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           ...
                           <form  id="add_product" method="POST" action="<?php echo $action;?>" data-form="ajaxform" enctype="multipart/form-data">
                              <div class="form-row">
                              <div class="col">
                             ...
                             <?php 
                              ...
                              <!--  <td>
								 ...
								 <td>
                                       ...
                                       <span class="table-remove"><button type="button"
                                       class="btn iq-bg-danger btn-rounded btn-sm my-0"><a href="<?php echo site_url(('update-product/'.$detail->id))?>">Update</a></button></span>
                                       <span class="table-remove"><input type="hidden" name="delitem" class="delitem" value="<?php echo $detail->name;?>"><input type="hidden" name="deltype" class="deltype" value="product">
